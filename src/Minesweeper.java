...
public class Minesweeper extends JFrame implements ActionListener { //class Minesweeper ต่อจาก JFrame และตรวจจับการกระทำ
	private static final long serialVersionUID = 1L;
	Object lostMsg = "You hit a Mine. Game Over. Better Luck Next Time!"; // Object
	Object wonMsg = "Congratulations, You Won the Game!\nTime: ";  // Object
	Object restartMsg = "Are you sure you want to Restart Game with new settings?"; //Object
	String[] imagenames = {"", "flag.png", "question_mark.png", "cross.png", "mine.png", "mine1.png", "clock.png"};//
	public Icon[] upperImages; //ตั้งให้ icon [] มีค่า = ตัวแปล upperImages (อยู่ในเมธอด public Minesweeper() )
	Image mineImage; // ประกาศตัวแปร แบบ  Image (อ่านภาพ 2d)
	int numberOfRows, numberOfCols, numberOfMines, timeElapsed;// ประกาศตัวแปร int ของ จำนวนของแถว,คอลัม,จำนวนระเบิด,ตัวจับเวลา
	boolean isGameOver; // ตัวแปร  boolean จะมีค่าแค่ 0 กับ 1 ไว้ตรวจสอบว่าเรา gameover หรือยัง
	Dimension size; // ตัวแปร array ไว้สร้างขนาดสนาม
	JPanel gamePanel = new JPanel(), scorePanel; // แสดง GUI สนาม
	JLabel timer, flag; // แสดง GUI นาฬิกา,ธง (รูปภาพ)
	TextField timerText, flagText; // แสดง GUI แบบอักษร เวลา,ธงที่เหลือ
	Timer clock; // ตัวนับเวลา
	JMenu optionsmenu, thememenu; // แท็บ options บนมุมซ้าย
	JMenuItem aboutitem; // คัวเลือกabout ในแท็บ options บนมุมซ้าย
	JMenuBar menubar; // แถวยาวๆที่แท็บ options บนมุมซ้าย (หัวของโปรแกรม)
	String[] optionsString = {"Beginner(10 mines, 9 x 9)", "Intermediate(40 mines, 16 x 16)", "Advanced(99 mines, 16 x 30)"}; //คัวเลือก ระดับความยากในเกม ใ
    // นแท็บ options บนมุมซ้าย ซึ่งระบุกติกาสากลไว้
	ButtonGroup optionsGroup = new ButtonGroup(); // รวมกลุ่มของObjectปุ่มที่ประกาศก่อนหน้า เป็นตัวแปรเดียว
	JRadioButtonMenuItem[] options = new JRadioButtonMenuItem[3];  // แสดงปุ่มรูปไข่ปลา(RadioButton) บนตัวเลือกความยากในแท็บ options
	MyJButton[][] button; // น่าจะแสดงปุ่มช่องที่เอาไว้กดเล่น
	Point[] mine; // ตำแหน่ง สุ่มระเบิดในเกม
